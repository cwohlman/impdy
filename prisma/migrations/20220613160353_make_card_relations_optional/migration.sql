...
INSERT INTO "new_Card" ("content", "createdAt", "id", "parentId", "resolutionId", "updatedAt", "userId") SELECT "content", "createdAt", "id", "parentId", "resolutionId", "updatedAt", "userId" FROM "Card";
DROP TABLE "Card";
